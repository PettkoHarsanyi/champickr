      ...
      <div id='mainDiv' className="z-9 w-10/12 h-screen items-center font-mono flex flex-col font-beaufort align-middle justify-center text-center p-10 mainDiv">
        ...
        <div id="championselect" className={`flex flex-row w-full championselect`}>
          <div className={`w-[30%] flex flex-col champRows`}>
            <div className='h-1/5 grborder1 flex flex-row p-3 gap-3 items-center'>
              <div className='h-full aspect-square relative' style={{ border: "0.2vh solid #b99c6a" }}>
                ...
                <div className='picshadow' onClick={pickFirst}></div>
              </div>
              <div className='h-3/4 m-5 aspect-square rounded-full' style={{ border: "0.2vh solid #b99c6a" }}></div>
            </div>
            <div className='h-1/5 grborder2 flex flex-row p-3 gap-3 items-center'>
              <div className='h-full aspect-square relative' style={{ border: "0.2vh solid #b99c6a" }}>
            ...
            <div className='h-1/5 grborder3 flex flex-row p-3 gap-3 items-center'>
              <div className='h-full aspect-square relative' style={{ border: "0.2vh solid #b99c6a" }}>
            ...
            <div className='h-1/5 grborder4 flex flex-row p-3 gap-3 items-center'>
              <div className='h-full aspect-square relative' style={{ border: "0.2vh solid #b99c6a" }}>
            ...
            <div className='h-1/5 grborder5 flex flex-row p-3 gap-3 items-center'>
              <div className='h-full aspect-square relative' style={{ border: "0.2vh solid #b99c6a" }}>
          ...
          <div id="champRows" className='w-[30%] flex flex-col gap-3 champRows'>
            <div className='h-1/5 grborder6 flex flex-row-reverse p-3 gap-3 items-center'>
            <div className='h-full aspect-square relative' style={{ border: "0.2vh solid #b99c6a" }}>
            ...
            <div className='h-1/5 grborder7 flex flex-row-reverse p-3 gap-3 items-center'>
            <div className='h-full aspect-square relative' style={{ border: "0.2vh solid #b99c6a" }}>
            ...
            <div className='h-1/5 grborder8 flex flex-row-reverse p-3 gap-3 items-center'>
            <div className='h-full aspect-square relative' style={{ border: "0.2vh solid #b99c6a" }}>
            ...
            <div className='h-1/5 grborder9 flex flex-row-reverse p-3 gap-3 items-center'>
            <div className='h-full aspect-square relative' style={{ border: "0.2vh solid #b99c6a" }}>
            ...
            <div className='h-1/5 grborder10 flex flex-row-reverse p-3 gap-3 items-center'>
            <div className='h-full aspect-square relative' style={{ border: "0.2vh solid #b99c6a" }}>
